                    ...
                    <div class="col-md-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="small text-muted mt-2">مجموع پرداختی: <?php echo number_format((int) round(((int) $categoryCounts['married_amount']) / 10)); ?> تومان</div>                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="small text-muted mt-2">مجموع پرداختی: <?php echo number_format((int) round(((int) $categoryCounts['male_amount']) / 10)); ?> تومان</div>                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="small text-muted mt-2">مجموع پرداختی: <?php echo number_format((int) round(((int) $categoryCounts['female_amount']) / 10)); ?> تومان</div>                            </div>
                        </div>
                    </div>
                </div>
